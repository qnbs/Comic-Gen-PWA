...
const DeleteConfirmModal: React.FC = () => {
    ...
    useFocusTrap(modalRef, !!projectToDelete, cancelDelete);

    if (!projectToDelete) return null;

    return (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
            <div ref={modalRef} className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                    {isBulkDelete 
                        ...
                        : t('comicLibrary.deleteConfirmBody', { title: projectToDelete.title || 'selected project' })}
                </p>
