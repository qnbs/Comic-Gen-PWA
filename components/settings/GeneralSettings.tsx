        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-sm font-semibold transition-colors"
            >
              {t('common.save')}
            </button>
            <button
              onClick={handleRemoveGeminiApiKey}
              className="px-3 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-md text-sm font-semibold transition-colors"
            >
              {t('common.delete')}
            </button>
          ...
          <p className="text-xs text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-2 rounded-md">
            {t('settingsPage.apiKeySecurityHint')}
          </p>
        </div>
      </div>
