...
const en = {
  ...
  settingsPage: {
    ...
    invalidApiKey: 'Please provide a valid Gemini API key.',
    apiKeySaved: 'Gemini API key saved securely.',
    apiKeyRemoved: 'Gemini API key removed.',
    importReadError: 'File could not be read as text.',
    importInvalidFormat: 'Imported settings file has an invalid format.',
  },
  confirmVideoModal: {
...
const de: typeof en = {
  ...
  settingsPage: {
    ...
    clickAgainToConfirm: 'Zum Bestätigen erneut klicken',
    resetDone: 'Einstellungen wurden auf Standard zurückgesetzt.',
    backupDescription:
      'Exportieren Sie alle Projekte und Medien in eine Backup-Datei oder importieren Sie ein bestehendes Backup.',
    exportAll: 'Alles exportieren',
    importBackup: 'Backup importieren',
    invalidApiKey: 'Bitte geben Sie einen gültigen Gemini API-Schlüssel an.',
    apiKeySaved: 'Gemini API-Schlüssel wurde sicher gespeichert.',
    apiKeyRemoved: 'Gemini API-Schlüssel wurde entfernt.',
    importReadError: 'Datei konnte nicht als Text gelesen werden.',
    importInvalidFormat: 'Importierte Einstellungsdatei hat ein ungültiges Format.',
  },
  confirmVideoModal: {
